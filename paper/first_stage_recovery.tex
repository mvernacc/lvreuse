...
\begin{table}
	...
	\begin{tabular}{p{3cm} p{3cm} p{2cm} c c}
		...
		\hline
		Yes, assume launch to LEO & Yes & Yes & \SIrange{2700}{3940}{\meter\per\second} & \SIrange{0.05}{0.07}{}\\
		No - Downrange landing & Yes & Yes & \SIrange{800}{1300}{\meter\per\second} & \SIrange{0.05}{0.07}{} \\
		No - Downrange landing & No - extra aero/TPS hardware & Yes & \SIrange{200}{500}{\meter\per\second} & \SIrange{0.05}{0.22}{}\\
		\hline
	\end{tabular}
\end{table}
