...
The price estimate distributions for these four vehicles all perform well, capturing the actual price per flight near the mode of the distribution. 

This lends credibility to the cost estimates for the various first stage reuse strategies. 
