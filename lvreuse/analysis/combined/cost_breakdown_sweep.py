...
def main():
    ...
    plt.stackplot(num_reuses, s1_e1_prod_cost_per_flight, s2_e2_prod_cost_per_flight, 
                  veh_int_checkout, ops_cost_per_flight - props_cost - refurb_cost, props_cost,
                  refurb_cost, labels=labels)
    ...
    plt.figure(figsize=(10, 6))
    ax = plt.subplot(1, 1, 1)
    plt.stackplot(launch_rate, s1_e1_prod_cost_per_flight, s2_e2_prod_cost_per_flight, 
                  veh_int_checkout, ops_cost_per_flight - props_cost - refurb_cost, props_cost, 
                  refurb_cost, labels=labels)
