...
ariane5 = LaunchVehicle("ariane5", 777, 4, ariane5_element_list)
...
ariane5_cost_factors = VehicleCostFactors(f0_dev=1.04**3, f0_prod=1.025, f6=1.0, f7=1.0, f8=0.86, f9=1.07, p=0.9)

ariane5_ops_cost_factors = OperationsCostFactors(f5_vehicle=0, f5_engine=0, f8=0.86, f11=1.0, fv=0.9, fc=0.85, p=0.9)
...
for launch_rate in launch_rate_range:
    ...
    #print dev_cost/total_num_launches
